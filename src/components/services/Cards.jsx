...
const Cards = ({title, direction, desc}) => {
    return (
        <motion.div  transition={{ duration: 1 }} initial={{ x: direction === "left" ? -200 : 200 }} whileInView={{ x: 0 }} className='flex flex-col justify-center items-center bg-[#333333] w-[450px] h-[280px] rounded-3xl pt-[6px] px-[28px] pb-0 max-[993px]:w-[400px] max-[360px]:w-[250px]' >
            <div className='text-start'>
                <h6 className='text-[#C4A66B] mb-4 text-xl max-[993px]:text-lg'>{title}</h6>
